...
?>
<a href="<?php echo esc_url( $home_url ); ?>" class="sf-volver">
    <span aria-hidden="true">&larr;</span> <?php esc_html_e( 'Volver al listado', 'shotfest-votaciones' ); ?>
</a>

<div class="sf-detalle-head">
    <?php if ( $marca ) : ?>
        <p class="sf-eyebrow"><?php echo esc_html( $marca ); ?></p>
    <?php endif; ?>
    <h1 class="sf-titulo"><?php echo esc_html( $titulo ); ?></h1>
</div>

<?php if ( $video_url ) : ?>
    <div class="sf-video-marco">
        <?php include SF_PLUGIN_DIR . 'templates/partials/youtube-embed.php'; ?>
    </div>
<?php endif; ?>

<div class="sf-voto-seccion">
    <?php if ( $ya_voto ) : ?>
        <p class="sf-ya-votado">
            <?php esc_html_e( 'Ya has emitido tu voto para este spot. El voto es definitivo y no puede modificarse.', 'shotfest-votaciones' ); ?>
        </p>
